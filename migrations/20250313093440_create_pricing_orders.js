...
exports.up = function(knex) {
    return knex.schema.createTable('pricing_orders', (table) => {
        ...
        table.date('adSpendStartDate').nullable();
        table.date('adSpendEndDate').nullable();
        ...
        table.date('youtubeBoostStartDate').nullable();
        table.date('youtubeBoostEndDate').nullable();

        table.boolean('googleAds').defaultTo(false);
        table.integer('googleBudget').defaultTo(0);
        table.date('googleBudgetStartDate').nullable();
        table.date('googleBudgetEndDate').nullable();
